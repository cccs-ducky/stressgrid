defmodule Stressgrid.CoordinatorWeb.ManagementLive do
            ...
            <div class="space-y-4">
              ...
              <%= for {key, values} <- Map.get(@state, "stats", %{}) |> Enum.sort_by(fn {k, _v} ->
                cond do
                  ...
                  String.starts_with?(to_string(k), "coordinator_cpu_percent_total") -> "2_#{k}"
                  String.starts_with?(to_string(k), "coordinator_") -> "3_#{k}"
                  String.starts_with?(to_string(k), "generator_cpu_percent") -> "4_#{k}"
                  String.starts_with?(to_string(k), "generator_") -> "5_#{k}"
                  true -> "6_#{k}"
                end
              end) do %>
                ...
                <div class="flex justify-between items-center">
                  <div class="flex w-full">
                    ...
                    <div class="flex-none flex items-center space-x-3">
                      ...
                      <%= if key == "generator_cpu_percent" || key == "coordinator_cpu_percent_total" do %>
                      ...
                      <div class="flex-1">
                        ...
                        <div class="mt-2 flex items-center space-x-4">
                          ...
                          <div class="flex items-center space-x-1">
                            ...
                            <span class="text-xs text-gray-900 dark:text-gray-100"><%= get_in(report, ["maximums", :generator_cpu_percent]) || 0 %>%</span>
    ...
    case List.first(values) do
      ...
      value when is_number(value) ->
        cond do
          ...
          String.ends_with?(key, "_percent") or String.contains?(key, "cpu_percent") ->
            "#{trunc(value)} %"
  ...
  defp is_red_cpu_max?(report) do
    case get_in(report, ["maximums", :generator_cpu_percent]) do
      value when is_number(value) -> value > 80
      _ -> false
    end
  end
