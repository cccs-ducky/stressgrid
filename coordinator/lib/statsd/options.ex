defmodule Statsd.Options do
  ...
  @spec formatter(term()) :: {:ok, Statsd.Formatter.t()} | {:error, String.t()}
  def formatter(:standard), do: {:ok, Statsd.Formatter.Standard}
  def formatter(:datadog), do: {:ok, Statsd.Formatter.Datadog}
